...
class DBC : Service() {
    ...
    override fun onCreate() {
        ...
        mNotification = NotificationCompat.Builder(this, "nccc").setAutoCancel(false)
        ...
        ServiceHelper.isOpenNotification = true
    }

    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        runCatching {
            // id需要修改
            startForeground(6545, mNotification)
        }
        return START_STICKY  // 必须用这个模式
    }

    override fun onDestroy() {
        ServiceHelper.isOpenNotification = false
        super.onDestroy()
    }
}